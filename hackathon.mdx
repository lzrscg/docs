...
<Card title="$10,000" icon="award">This award goes to the best Web2-style app that can be verified using Celestia and other Web3 technologies. Apps will be judged according to their usefulness and viability in a Web2 context, but must have verifiable or replayable state in order to qualify.</Card>
